...
<body style="background-color:#04C5F9">
	...
	?>
		...
		<form action="signup.php" method="post">
			...
			<button type="submit" name="submit" onClick="gotojs($_POST[lastname]);" class="credentials" style="margin-top:5%; text-align:center; background-color:#04C5F9; color:white;"> Sign Up </button>				
		</form>
		</div>
	</div>
</body>
